...
import { Table, Heading, Text, Pane, EditIcon, IconButton, TextInput, TickIcon, Button, ChevronRightIcon, PlusIcon, toaster } from 'evergreen-ui';
...
const ColumnTable = () => {
	...
	return (
		<Pane elevation={1} padding={50} paddingTop={20}>
			<Pane alignContent='center' alignItems='center' flexDirection='row' display='flex' justifyContent='space-between' marginBottom={20}>
				<Pane>
				...
				<Button appearance='primary' iconAfter={ChevronRightIcon} onClick={handleSubmit} isLoading={isSubmitLoading}>
					Done
				</Button>
			</Pane>
			<Pane>
				<Pane alignContent='center' alignItems='center' flexDirection='row' display='flex' justifyContent='space-between'>
					<Text color='gray600'>Columns</Text>
					<Button marginLeft={10} marginBottom={10} iconBefore={PlusIcon} onClick={handleNewColumn}>
						New Column
					</Button>
				</Pane>
